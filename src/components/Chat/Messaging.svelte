...
<div class="flex flex-col justify-between gap-20 h-full font-mulish font-medium">
            ...
            >
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="space-y-2 mt-6">
                            <p class="px-4 py-2 text-sm bg-gray-100 rounded-lg rounded-bl-none text-[#808990]">{msg.text}</p>
                            <div class="flex gap-4 items-center">
                                <img src={copyIcon} width="16" height="16" class="cursor-pointer" alt="copy Icon">
                                <img src={like} width="16" height="16" class="cursor-pointer" alt="Like Icon">
                                <img src={thumDown} width="16" height="16" class="cursor-pointer" alt="thumb down">
                                <img src={megaphone} width="16" height="16" class="cursor-pointer" alt="mega phone">
                            </div>
                        </div>
                    </div>
                    {:else}
                        <div class="flex flex-col">
                            ...
                            <img src={copyIcon} class="self-end mt-1 cursor-pointer" width="16" height="16" alt="copy Icon">
                        </div>
                    {/if}
            </div>
        </div>
    ...
    <div class="sticky bottom-0 bg-white flex flex-col gap-4">
        <div class="border border-[#E8E8E8] rounded-[20px] p-4 bg-white shadow-md">
            ...
            <div class="flex justify-between">
                        ...
                        <div class="flex gap-2 items-center">
                            <button onclick={triggerFileUpload} class="p-2 h-[48px] w-[48px] border rounded-full hover:bg-gray-100">
        ...
        <p class="font-satoshi-regular font-light text-[14px] text-[#686868] self-center">By messaging RafikiX, you agree to our Terms and Conditions</p>
