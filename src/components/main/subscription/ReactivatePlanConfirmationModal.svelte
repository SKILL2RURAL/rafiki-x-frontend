...
<Dialog.Root open={isOpen} onOpenChange={handleOpenChange}>
	...
	>
		<div class="relative">
			<!-- Title -->
			<h2 class="text-[24px] font-bold text-[#253B4B] mb-4">Renew Plan</h2>
			...
			<p class="text-[#253B4B] text-[16px] mb-6">
				Are you sure you want to renew your subscription plan?
			</p>
			...
			<div class="flex gap-3 justify-end">
				...
				<Button
					class="bg-gradient text-white rounded-[8px] h-[40px] px-6 hover:opacity-90"
