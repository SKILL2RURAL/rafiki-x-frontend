...
<Layout>
	...
	>
		...
		<div
			class="bg-gradient-background px-4 sm:px-6 lg:px-10 py-8 lg:py-10 w-full max-w-6xl rounded-[20px] text-center font-mulish text-white relative mt-5 lg:mt-10"
		>
			<button
				onclick={() => {
					goto('/');
