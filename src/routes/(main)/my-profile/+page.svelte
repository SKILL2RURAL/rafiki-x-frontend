		...
		<div class="px-5 lg:px-10 my-5 lg:my-0 mb-30 lg:mb-0">
			...
			<div class="flex gap-4 mb-6 bg-[#F4F4F5] rounded-[10px] p-3 w-fit">
				<button
					...
					class={cn(
						'px-4 py-2 text-[16px] font-medium rounded-lg transition-colors relative',
				...
				<button
					...
					class={cn(
						'px-4 py-2 text-[14px] md:text-[16px] font-medium rounded-lg transition-colors relative',
